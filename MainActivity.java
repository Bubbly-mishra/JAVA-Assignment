    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonEqual.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Addition && edt1.getText().length() == 3) {

                    edt1.setText(input1 + input2 + "");
                    Addition = false;
                }

                if (Subtract && edt1.getText().length() == 3 || edt1.getText().length() == 0) {

                    edt1.setText(input1 - input2 + "");
                    Subtract = false;
                }

                if (Multiplication && edt1.getText().length() == 3) {
                    edt1.setText(input1 * input2 + "");
                    Multiplication = false;
                }

                if (Division && edt1.getText().length() == 3) {
                    edt1.setText(input1 / input2 + "");
                    Division = false;
                }
                if (mRemainder && edt1.getText().length() == 3) {
                    edt1.setText(input1 % input2 + "");
                    mRemainder = false;
                }
            }
